...
def test_specific_fixes():
    ...
    try:
        ...
        # Test Query 4: Percentage calculation fix (MXD company)
        print("\n📝 Testing Query 4: MXD percentage calculation fix")
        ...
        # Test Query 5: Percentage calculation fix (HEC company)
        print("\n📝 Testing Query 5: HEC percentage calculation fix")
        query5 = "What percent of HEC's operating expenses are from insurance in total for 2021?"
        answer5 = excel_query(query5, file_rep)
        print(f"Query: {query5}")
        print(f"Answer: {answer5}")
        
        # Test Query 6: Company matching fix (Branch company)
        print("\n📝 Testing Query 6: Branch company matching fix")
